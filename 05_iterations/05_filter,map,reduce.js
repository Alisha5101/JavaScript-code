...
// filter:filter return new array , it does not modify original aaray
const filterValue=obj.filter( (value)=>{
    if(value.id%2==0){
        return false;
    }
    return true
...
// map method:map is used to modify and access array , it creates new array

let mapValue=obj.map( (value)=>{
return value.id})
